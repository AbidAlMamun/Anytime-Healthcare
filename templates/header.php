        ...
        <header class="d-none <?php echo _get_is_logged_in() ? "d-lg-block" : "d-md-block"; ?> container bg-<?php echo _CONFIG["THEME_COLOR"]; ?> p-3">
            <div class="row">
                <div class="col-12 col-md-3 text-center text-md-start">
                    <a href="<?php echo _get_url("index.php"); ?>" class="navbar-brand-md h2 text-decoration-none text-white"><i class="bi bi-life-preserver text-white display-5"></i> <b>Anytime Healthcare</b></a>
