    ...
    <footer class="container bg-<?php echo _CONFIG["THEME_COLOR"]; ?> p-3">
        <div class="row">
            <div class="col-12 text-center">
                <p class="text-white mb-0"><span class="text-white"><?php echo date("Y"); ?> &copy; Copyright by <strong><a href="<?php echo _get_url("about.php"); ?>" class="list-group-item d-inline text-<?php echo _CONFIG['THEME_COLOR']; ?> rounded p-1">Abid Al Mamun</a></strong></span></p>
            </div>
        </div>
    </footer>
